...
{
 $sql_query="DELETE FROM acounts WHERE Accounts_id=".$_GET['delete_id'];
...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="">Volunteer Page</a>
        </div>
...
<div id="body">
 <div id="content">
    <label>Welcome Volunteer<a href="#" target="_blank"></a></label>
    </div>
 ...
 ?>
	...
	<th>Adress</th>
	<th>Contact</th>
	<th>Nights Offered</th>
	<th>Guest Capacity</th>
	<th>Trip Rounds</th>
    <th >Operations</th>
    </tr>
    <?php
  $sql_query="SELECT * FROM volunteer WHERE Accounts_id=".$_SESSION['sess_user_id'];
   $result_set = mysqli_query($connection, $sql_query) or die($sql_query."<br/><br/>".mysql_error());
